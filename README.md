...
```powershell
npm run dev -- C:\Users\akp\Downloads\pinpoint
```
...
Pin Point starts a public Cloudflare tunnel automatically. Send the printed public
review link to your client. Keep the tokenized dashboard link private.

If the tunnel is unavailable, Pin Point continues with local URLs and explains how
to restore public sharing.
